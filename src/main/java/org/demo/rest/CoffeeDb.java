...
public class CoffeeDb {
    ...
    public Object readFromDatabase() throws SQLException{
        ...
        try (
            ...
            PreparedStatement statement = connection.prepareStatement("SELECT id,name,price from COFFEE");
        ) {
    ...
    private void createCoffeeTable(Connection connection) throws SQLException{
        try (
            PreparedStatement createStatement = connection.prepareStatement(
                "CREATE TABLE COFFEE (id INT NOT NULL PRIMARY KEY, name VARCHAR(128), price VARCHAR(10) )"
            );
        ) {
